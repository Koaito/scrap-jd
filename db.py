...
# Giữ tên cũ làm alias — tránh phải sửa lại toàn bộ chỗ gọi cùng lúc.
# Tên mới (get_province_id) phản ánh đúng hành vi thật: CHỈ tra cứu,
# KHÔNG tạo mới (xem docstring get_province_id() ở trên).
